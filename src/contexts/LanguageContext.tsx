  ...
  pt: {
    ...
    services: {
      ...
      sales: {
        ...
        description: 'Para atender clientes de cimento, cal, milho e soja em percurso de longas distâncias.',
      },
      rental: {
        title: 'Carreta Silo 3 Eixos PBTC 48,5t',
        description: 'Para atender os clientes de cimento, cal, milho e soja em percurso de média distância.',
      },
      transport: {
        title: 'Carretas Basculantes',
        description: 'Para atender clientes no segmento de mineração, Siderúrgica, Pedreiras e obras de terraplanagem.',
      },
      cta: 'Saiba Mais',
    },
    timeline: {
